...
export default function ContractPreview({ data, contractType, onBack }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Contract Preview */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 md:p-12 print:shadow-none">
        {/* Contract Header */}
        <div className="text-center border-b-2 border-gray-800 dark:border-gray-200 pb-6 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 space-y-1">
              ...
              <p className="text-gray-600 dark:text-gray-400">{data.vermieterStrasse}</p>
              <p className="text-gray-600 dark:text-gray-400">{data.vermieterPlz} {data.vermieterOrt}</p>
              {data.vermieterTelefon && (
                <p className="text-gray-600 dark:text-gray-400">Tel: {data.vermieterTelefon}</p>
              )}
              {data.vermieterEmail && (
                <p className="text-gray-600 dark:text-gray-400">E-Mail: {data.vermieterEmail}</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 space-y-1">
              ...
              {data.mieterTelefon && (
                <p className="text-gray-600 dark:text-gray-400">Tel: {data.mieterTelefon}</p>
              )}
              {data.mieterEmail && (
                <p className="text-gray-600 dark:text-gray-400">E-Mail: {data.mieterEmail}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div>
                <p className="text-sm text-gray-500">Gesamtmiete monatlich</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 space-y-2">
            ...
            {!data.staffelmiete && !data.indexmiete && !data.haustiereErlaubt && 
             !data.kleinreparaturklausel && !data.schoenheitsreparaturen && (
              <p className="text-gray-500">Keine besonderen Vereinbarungen.</p>
            )}
          </div>
        </div>

        {/* Signature Fields */}
        <div className="border-t-2 border-gray-300 dark:border-gray-600 pt-8 mt-12">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <div className="border-b-2 border-gray-400 dark:border-gray-500 h-16 mb-2"></div>
